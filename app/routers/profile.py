...
@router.post("/users/me/profile", description="Create a new profile or update an existing profile for the current user.")
...
@router.get("/users/me/profile", response_model=Profile, description="Retrieve the profile of the current user.")
...
@router.put("/users/me/edit-profile", response_model=Profile, description="Edit the profile of the current user.")
...
@router.delete("/users/me/delete-profile", description="Delete the profile of the current user.")
